...
const TimRechargeSimplePage = () => {
  ...
  const timPackages = [
    ...
    { paid: 35.00, received: 60.00 },
    { paid: 50.00, received: 100.00 }
  ];
          ...
          <Card className="glass-strong border-0 text-white">
            ...
            <CardContent>
              <div className="space-y-4">
                <Label htmlFor="phone" className="text-white">Número TIM</Label>
                <Input
                  id="phone"
                  type="tel"
                  value={phoneNumber}
                  ...
                  data-testid="tim-simple-phone-input"
                />
              </div>
            </CardContent>
          </Card>
              ...
              <div className="space-y-3">
                {timPackages.map((pkg, index) => (
                  <Button
                    ...
                    variant="ghost"
                    data-testid={`tim-simple-package-${index}`}
                  >
...
export default TimRechargeSimplePage;