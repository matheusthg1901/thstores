...
const VivoRechargePage = () => {
  ...
  const vivoPackages = [
    { paid: 5.00, received: 20.00 },
    { paid: 7.50, received: 30.00 },
    { paid: 10.00, received: 40.00 },
    { paid: 15.00, received: 50.00 },
    { paid: 18.00, received: 60.00 }
  ];
      ...
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center space-x-4">
            ...
            <h1 className="text-3xl font-bold gradient-text">Recarga Vivo</h1>
          </div>
          ...
          <Card className="glass-strong border-0 text-white">
            ...
            <CardContent>
              <div className="space-y-4">
                <Label htmlFor="phone" className="text-white">Número Vivo</Label>
                <Input
                  id="phone"
                  type="tel"
                  value={phoneNumber}
...
export default VivoRechargePage;